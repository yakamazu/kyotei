  ...
  try:
    ...
    for list_page in url_list:
      ...
      race_info.update(rank1_prob_1=float(rf_1[:,0].round(2)),rank1_prob_2=float(rf_1[:,1].round(2)),rank1_prob_3=float(rf_1[:,2].round(2)),rank1_prob_4=float(rf_1[:,3].round(2)),rank1_prob_5=float(rf_1[:,4].round(2)),rank1_prob_6=float(rf_1[:,5].round(2)),
                       ...
                       tansyo_exp_1=float(race_info['tansyo_odds_1'] if float(race_info['tansyo_odds_1']) >= 1 else 15) * 100 * float(rf_1[:,0].round(2)),tansyo_exp_2=float(race_info['tansyo_odds_2'] if float(race_info['tansyo_odds_2']) >= 1 else 15) * 100 * float(rf_1[:,1].round(2)),tansyo_exp_3=float(race_info['tansyo_odds_3'] if float(race_info['tansyo_odds_3']) >= 1 else 15) * 100 * float(rf_1[:,2].round(2)),tansyo_exp_4=float(race_info['tansyo_odds_4'] if float(race_info['tansyo_odds_4']) >= 1 else 15) * 100 * float(rf_1[:,3].round(2)),tansyo_exp_5=float(race_info['tansyo_odds_5'] if float(race_info['tansyo_odds_5']) >= 1 else 15) * 100 * float(rf_1[:,4].round(2)),tansyo_exp_6=float(race_info['tansyo_odds_6'] if float(race_info['tansyo_odds_6']) >= 1 else 15) * 100 * float(rf_1[:,5].round(2)),
